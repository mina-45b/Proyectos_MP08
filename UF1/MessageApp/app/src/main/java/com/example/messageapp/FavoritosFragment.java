...
import com.example.messageapp.databinding.FragmentFavoritosBinding;
...
public class FavoritosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentFavoritosBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewFavoritos.setAdapter(mensajesAdapter);

        binding.recyclerViewFavoritos.addItemDecoration(new DividerItemDecoration(requireContext(), DividerItemDecoration.VERTICAL));
        ...
        }).attachToRecyclerView(binding.recyclerViewFavoritos);
    ...
    LiveData<List<Mensaje>> obtenerMensajes() {return mensajesViewModel.obtenerFavoritos();}
    ...
    class MensajesAdapter extends RecyclerView.Adapter<MensajeViewHolder> {
        ...
        public MensajeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new MensajeViewHolder(ViewholderMensajesRecibidosBinding.inflate(getLayoutInflater(), parent, false));
        }
    ...
    static class MensajeViewHolder extends RecyclerView.ViewHolder {
        ...
        public MensajeViewHolder(ViewholderMensajesRecibidosBinding binding) {
