...
import com.example.messageapp.databinding.FragmentHomeRecibidosBinding;
...
public class HomeRecibidosFragment extends Fragment {

    FragmentHomeRecibidosBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentHomeRecibidosBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewRecibidos.setAdapter(mensajesAdapter);

        binding.recyclerViewRecibidos.addItemDecoration(new DividerItemDecoration(requireContext(), DividerItemDecoration.VERTICAL));
        ...
        }).attachToRecyclerView(binding.recyclerViewRecibidos);
    ...
    LiveData<List<Mensaje>> obtenerMensajes() {return mensajesViewModel.obtenerMensajesRecibidos();}
