...
import com.example.messageapp.databinding.FragmentEnviadosRecyclerMensajeBinding;
import com.example.messageapp.databinding.ViewholderMensajesEnviadosBinding;
...
public class EnviadosRecyclerMensajeFragment extends Fragment {

    FragmentEnviadosRecyclerMensajeBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return (binding = FragmentEnviadosRecyclerMensajeBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerViewEnviados.setAdapter(mensajesAdapter);

        //Línea divisoria
        binding.recyclerViewEnviados.addItemDecoration(new DividerItemDecoration(requireContext(), DividerItemDecoration.VERTICAL));
        ...
        }).attachToRecyclerView(binding.recyclerViewEnviados);
    ...
    LiveData<List<Mensaje>> obtenerMensajes() {return  mensajesViewModel.obtenerMensajesEnviados();}
    ...
    class MensajesAdapter extends RecyclerView.Adapter<MensajeViewHolder> {
        ...
        public MensajeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new MensajeViewHolder(ViewholderMensajesEnviadosBinding.inflate(getLayoutInflater(), parent, false));
        }
        ...
        public void onBindViewHolder(@NonNull MensajeViewHolder holder, int position) {
            ...
            holder.binding.usuario.setText(mensaje.destinario);
    ...
    static class MensajeViewHolder extends RecyclerView.ViewHolder {
        private final ViewholderMensajesEnviadosBinding binding;

        public MensajeViewHolder(ViewholderMensajesEnviadosBinding binding) {
